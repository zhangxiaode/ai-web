<template>
  <div class="h-100% px-32px overflow-hidden flex flex-col items-normal">
    ...
    >
      <n-form-item path="name" label="镜头序号">
        <n-input-number v-model:value="searchForm.index" size="small" :show-button="false" placeholder="请输入镜头序号" @keyup.enter.native="getList" />
      </n-form-item>
      <n-form-item>
