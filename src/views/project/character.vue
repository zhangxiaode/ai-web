  ...
  <div class="h-100% px-32px overflow-hidden flex flex-col items-normal">
    ...
    >
      <n-form-item path="name" label="角色名称">
        <n-input v-model:value="searchForm.name" size="small" placeholder="请输入角色名称" @keyup.enter.native="getList()" />
      </n-form-item>
      <n-form-item>
    ...
    <div class="flex-1 overflow-auto character-wrap" v-loading="loading">
    ...
    />
    <NewCharacterModal @save="handleNewModalComplete" />
  </div>
</template>
<script lang="ts" setup>
import { useModal } from "@/hooks";
import { Search, Repeat, AddSharp, CreateOutline, TrashOutline } from '@vicons/ionicons5';
import { getCharacterList, deleteCharacter } from '@/apis/index';
