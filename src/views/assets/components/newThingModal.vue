        ...
        >
          ...
          <n-form-item label="物品图片:" path="resource_path">
            <div class="flex flex-col">
              ...
              <UploadObs ref="uploadRef" accept="image/*" :max="1" :size_max="10" :get_file_path="({ user_id, file_name }) => `thing/${user_id}/${file_name}`" @change="({ resource_path }) => form.resource_path = resource_path[0].original_url" />
            </div>
          </n-form-item>
        </n-form>
